...
function createProduct() {
  //... your code goes here
  let price = document.querySelector ('#new-price').value; // recuperar el precio que ha introducido el usuario al crear el producto
  let name = document.querySelector('#new-name').value
  ; // recuperar el nombre que la ha dado el usuario al nuevo producto
